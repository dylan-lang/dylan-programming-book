...
define constant <limited-integer-1> = limited(<integer>, min: -2, max:
2);

define constant <limited-integer-2> = limited(<integer>, min: 0, max:
4);
...
define constant $v1 = make(<limited-vector-of-3-integers>, size: 3,
fill: 1);
...
*// Method 2
* define method say (x :: <limited-vector-of-3-integers>) ... end method
say;

*// Method 3
* define method say (x :: <limited-vector-of-3-numbers>) ... end method
say;
